    ...
    <div className="navbar">
      <ul className="nav">
        <li className="nav-item">
          <a aria-label="Mon GitHub" href="https://github.com/RaphaelHardFork" target="_blank" rel="noopener noreferrer" className="nav-link">
        ...
        <li className="nav-item">
          <a aria-label="Mon Discord" href="@Raphael Pellet#8885" target="_blank" rel="noopener noreferrer">
